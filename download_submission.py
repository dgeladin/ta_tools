...
def get_assignment_info(assignment_name, should_pull_repo_flag=None,
    ...
    assignment_dict = {
      ...
      'I2': {
        'deadline' : '2019-04-14 00:05:00',
        'assignment_name' : 'I_D2',
        },
      'I3': {
        'deadline' : '2019-04-21 00:05:00',  # note: summer doesn't use I3
        'assignment_name' : 'I_D3',
        },
      'T0': {
        'deadline' : '2019-02-10 00:05:00',
        'assignment_name' : 'T_D0',
        },
      'T1': {
        'deadline' : '2019-02-17 00:05:00',
        'assignment_name' : 'T_D1',
        },
      'T2': {
        'deadline' : '2019-02-24 00:05:00',
        'assignment_name' : 'T_D2',
        },
      'T3': {
        'deadline' : '2019-03-03 00:05:00',
        'assignment_name' : 'T_D3',
        },
      'T4': {
        'deadline' : '2019-03-10 00:05:00',
